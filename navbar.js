...
const Navbar = () => {
  ...
  return (
    <div className={`fixed top-0 z-50 w-full h-[70px] flex justify-between items-center px-4 text-green-600 ${isScrolled ? "bg-blue-900" : "bg-transparent"}`} >
      <div className="text-4xl cursor-pointer inline-flex items-center text-green-600">
      <Link to="home" smooth={true} duration={500}>
          <img src= {Image}  alt="Logo" className="h-15 w-20 mr-2" /> 
        </Link>
        </div>
      ...
      <div className="hidden md:flex">
        <button className="px-4 py-2 bg-green-800 text-white rounded-md hover:bg-blue-900 hover:text-white mx-2">
      ...
      <div
        ...
        } md:hidden flex flex-col bg-blue-900 text-green-600 w-full absolute top-16 left-0 z-10`}
      >
        <Link
          to="home"
          smooth={true}
