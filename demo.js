...
const Demo = () => {
  return (
    <div id="demo" className="flex flex-col md:flex-row w-full h-screen bg-green-800">
      <div className="w-full md:w-1/2 p-4 md:p-8 bg-gray-100 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold mb-4">Cube   <span className="text-blue-800">Home Builders</span> Actions & Demo</h1>
      ...
      <div className="w-full md:w-1/2 p-8 flex items-center justify-center">
        ...
        <h2 className="text-1xl font-bold mb-4">Cube Home Builders</h2>
